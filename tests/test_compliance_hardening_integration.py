...
print("  Status: PASS" if result.overall_passed else "  Status: FAIL")
print("  ✓ Strict compliance evaluation working")
...
print("  ✓ Regulatory tier switching working")
...
print("  IND Tier - Active thresholds:")
...
print("  ✓ Parametrized toxicity gate working")
