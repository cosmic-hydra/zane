...
async def execute_zane_pipeline(patient_profile_path: str, target_disease: str, metadata: dict[str, Any] | None = None):
    """
    ...
    excellence_score = await reward_orchestrator.calculate_total_reward(
        final_smiles, {"docking_score": 0.95, "admet_score": 0.88}
    )
