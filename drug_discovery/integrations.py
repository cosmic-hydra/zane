...
INTEGRATIONS: dict[str, IntegrationSpec] = {
    ...
    "molecular_transformer": IntegrationSpec(
        ...
        purpose="Reaction outcome prediction (reactants → products)",
        url="https://github.com/pschwllr/MolecularTransformer",
        python_modules=("molecular_transformer",),
        submodule_path="external/MolecularTransformer",
    ),
    "diffdock": IntegrationSpec(
        key="diffdock",
        name="DiffDock",
        purpose="Diffusion-based protein–ligand docking (3D pose prediction)",
        url="https://github.com/gcorso/DiffDock",
        python_modules=("diffdock",),
        submodule_path="external/DiffDock",
    ),
    "torchdrug": IntegrationSpec(
        key="torchdrug",
        name="TorchDrug",
        purpose="GNN-based property prediction (toxicity, solubility, bioactivity)",
    ...
    "openfold": IntegrationSpec(
        key="openfold",
        name="OpenFold",
        purpose="Protein 3D structure prediction (AlphaFold-compatible)",
    ...
    "openmm": IntegrationSpec(
        key="openmm",
        name="OpenMM",
        purpose="Molecular dynamics simulation (drug–protein stability)",
    ...
    "pistachio": IntegrationSpec(
        key="pistachio",
        name="Pistachio",
        purpose="Patent-scale reaction dataset tools",
