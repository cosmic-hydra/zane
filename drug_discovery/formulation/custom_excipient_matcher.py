...
class PersonalizedFormulationEngine:
        ...
        self.excipient_knowledge_base = pd.DataFrame(
            [
                ...
                {"name": "Lactose", "category": "Filler", "contraindications": ["lactose_intolerance"]},
                {
                    "name": "Ethanol",
                    "category": "Solvent",
                    "contraindications": ["liver_failure", "alcoholism", "pregnancy"],
                },
                {"name": "Propylene Glycol", "category": "Solvent", "contraindications": ["renal_failure"]},
                {
                    "name": "Mannitol",
                    "category": "Diuretic/Sweetener",
                    "contraindications": ["anuria", "severe_dehydration"],
                },
    ...
    def veto_contraindicated_vehicles(
        self, patient_state: Any, proposed_formulations: list[dict[str, Any]]
    ) -> list[dict[str, Any]]:
        """
